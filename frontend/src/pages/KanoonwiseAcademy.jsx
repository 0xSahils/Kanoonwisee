...
const KanoonwiseAcademy = () => {
  ...
  const categories = (pageContent?.frontmatter?.categories && !loadError && Array.isArray(pageContent.frontmatter.categories)) 
    ...
    const articles = (pageContent?.frontmatter?.articles && !loadError && Array.isArray(pageContent.frontmatter.articles))
  ...
  const upcomingEvents = (pageContent?.frontmatter?.upcomingEvents && !loadError && Array.isArray(pageContent.frontmatter.upcomingEvents))
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          {loadError && (
            <p className="text-yellow-600 text-sm mt-2">Using fallback content</p>
          )}
        </div>
      </div>
    );
