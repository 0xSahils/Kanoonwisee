...
const KanoonwiseAcademy = () => {
  ...
  const categories =
    ...
    !loadError &&
    Array.isArray(pageContent.frontmatter.categories)
      ? pageContent.frontmatter.categories
      : [
  ...
  const articles =
    pageContent?.frontmatter?.articles &&
    !loadError &&
    Array.isArray(pageContent.frontmatter.articles)
      ? pageContent.frontmatter.articles
      : [
          {
            id: 1,
  ...
  const upcomingEvents =
    pageContent?.frontmatter?.upcomingEvents &&
    !loadError &&
    Array.isArray(pageContent.frontmatter.upcomingEvents)
      ? pageContent.frontmatter.upcomingEvents
      : [
          {
            id: 1,
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300">
                  Explore our comprehensive legal knowledge library
                </p>
              </div>
              <button
                onClick={() =>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our most popular and comprehensive guides to help you understand
              business law
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Browse our comprehensive collection of legal guides and business
              insights
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredArticles.map((article, index) => {
              ...
              return (
                <div
                  key={article.id}
                  className={`bg-gradient-to-br ${cardColor} border rounded-2xl p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1`}
                >
                  <div className="flex items-center justify-between mb-4">
                    <span
                      className={`${badgeColor} px-3 py-1 rounded-full text-sm font-semibold shadow-sm`}
                    >
                      {
                        categories.find((cat) => cat.id === article.category)
                          ?.name
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join our expert-led workshops, masterclasses, and webinars to
