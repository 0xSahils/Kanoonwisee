          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 leading-relaxed max-w-2xl">
                  Protect your intellectual property and brand assets with comprehensive IP services. From trademark registration to patent consultation - secure your innovations.
                </p>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-white mb-4">Protect Your Brand Today</h3>
                <p className="text-gray-300">Choose the right IP protection service for your business</p>
              </div>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4">
              ...
              >
                ...
                <div className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-yellow-600 font-semibold mb-3">{service.subtitle}</p>
                    ...
                    <div className="bg-blue-50 p-3 rounded-lg mb-6">
                      <div className="flex items-center justify-center">
                        ...
                        <span className="font-semibold text-blue-800">Timeline: {service.timeline}</span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-4">
              <strong>Note:</strong> Government fees are additional and vary by service type. We'll provide exact amounts before processing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Brand Protection</h3>
              <p className="text-gray-600">Protect your brand identity and prevent unauthorized use by competitors</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-yellow-100 rounded-full mb-6">
              ...
              <p className="text-gray-600">Increase your business valuation with protected intellectual property assets</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-yellow-100 rounded-full mb-6">
                <i className="fas fa-gavel text-yellow-600 text-2xl"></i>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Legal Rights</h3>
              <p className="text-gray-600">Gain exclusive legal rights to use and license your intellectual property</p>
            </div>
          </div>
        </div>
      </section>
