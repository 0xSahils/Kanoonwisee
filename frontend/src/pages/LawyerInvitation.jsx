        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300">
              {step === "registration" && "Fill out the form below and we'll send you an OTP for verification."}
              {step === "otp" && "Please enter the 6-digit OTP sent to your email address."}
              {step === "profile" && "Setting up your profile to start receiving client requests..."}
              {step === "success" && "Welcome to KanoonWise! You'll be redirected to login shortly."}
            </p>
          </div>
          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center space-x-4">
              <div className={`flex items-center justify-center w-8 h-8 rounded-full ${
                step === "registration" ? "bg-yellow-500 text-gray-900" : 
                step !== "registration" ? "bg-green-500 text-white" : "bg-gray-600 text-gray-300"
              }`}>
                1
              </div>
              <div className="w-12 h-1 bg-gray-600"></div>
              <div className={`flex items-center justify-center w-8 h-8 rounded-full ${
                step === "otp" ? "bg-yellow-500 text-gray-900" : 
                step === "profile" || step === "success" ? "bg-green-500 text-white" : "bg-gray-600 text-gray-300"
              }`}>
                2
              </div>
              <div className="w-12 h-1 bg-gray-600"></div>
              <div className={`flex items-center justify-center w-8 h-8 rounded-full ${
                step === "profile" ? "bg-yellow-500 text-gray-900" : 
                step === "success" ? "bg-green-500 text-white" : "bg-gray-600 text-gray-300"
              }`}>
                3
              </div>
            </div>
          ...
          {step === "profile" && (
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200 max-w-md mx-auto text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Setting up your profile...</h3>
              <p className="text-gray-600 mb-6">
                We're creating your lawyer profile with the information you provided.
              </p>
          ...
          {step === "success" && (
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200 max-w-md mx-auto text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Welcome to KanoonWise!</h3>
              <p className="text-gray-600 mb-6">
                Your registration is complete. You can now log in and start receiving client requests.
              </p>
              
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <p className="text-sm text-gray-600">
                  <strong>Next Steps:</strong><br />
                  • Log in to complete your detailed profile<br />
                  • Set your consultation fees<br />
